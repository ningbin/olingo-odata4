...
public class EdmDateTimeOffsetTest extends PrimitiveTypeBaseTest {
	...
	public void valueToStringFromJavaUtilDate() throws Exception {
		...
		assertEquals("2012-02-29T23:32:03.007Z", instance.valueToString(date, null, 
		    null, null, null, null));
		assertEquals("2012-02-29T23:32:03.007Z", instance.valueToString(date, null, 
		    null, 3, null, null));
	}
	...
	public void valueToStringFromTimestamp() throws Exception {
		...
		assertEquals("1970-01-01T00:00:00.00000012Z", instance.valueToString(timestamp, 
	...
	public void valueOfStringToInstant() throws Exception {
		...
		assertEquals(instant,
				instance.valueOfString("2012-02-29T01:02:03Z", null, null, null, 
				    null, null, Instant.class));
		assertEquals(instant,
				instance.valueOfString("2012-02-29T01:02:03", null, null, null, 
				    null, null, Instant.class));
	}
	...
	public void valueOfStringToZonedDateTime() throws Exception {
		...
		assertEquals(zdt,
				instance.valueOfString("2012-02-29T01:02:03-01:30", null, null, 
				    null, null, null, ZonedDateTime.class));
	}
	...
	public void valueOfStringToTimestamp() throws Exception {
		assertEquals(530000001, instance
				.valueOfString("2012-02-29T01:02:03.530000001+11:00", null, null, 9, null, null, 
				    Timestamp.class)
				.getNanos());
	}
	...
	public void valueOfStringToLong() throws Exception {
		...
		assertEquals(Long.valueOf(dateTime.getTimeInMillis()),
				instance.valueOfString("2012-02-29T01:02:03+00:00", null, null, null, null, null, 
				    Long.class));
		assertEquals(Long.valueOf(120000L),
				instance.valueOfString("1970-01-01T00:02Z", null, null, null, null, null, 
				    Long.class));
		assertEquals(Long.valueOf(120000L),
				instance.valueOfString("1970-01-01T00:02", null, null, null, null, null, 
				    Long.class));

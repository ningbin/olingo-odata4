...
public class ODataJsonSerializerv01Test {
  ...
  public void selectMissingId() throws Exception {
    ...
    final SelectOption select = ExpandSelectMock.mockSelectOption(Arrays.asList(
      ...
      InputStream result = serializer.entity(metadata, entityType, entity,
          ...
          final String resultString = IOUtils.toString(result);
           Assert.assertEquals(  "{\"@context\":\"$metadata#ESAllPrim"
               + "(PropertyInt16,PropertyBoolean,PropertyDate)/$entity\","+
    ...
    final String resultString = IOUtils.toString(serializer
        .entity(metadata, entityType, entity,
            EntitySerializerOptions.with()
                ...
                .build()).getContent());
    Assert.assertEquals("{"
        + "\"@context\":\"$metadata#ESTwoPrim(PropertyInt16,NavPropertyETAllPrimOne(PropertyInt16,PropertyDate))/"
        + "$entity\","
        + "\"@metadataEtag\":\"W/\\\"metadataETag\\\"\","
        + "\"PropertyInt16\":32767,\"PropertyString\":\"Test String4\","
        + "\"NavPropertyETAllPrimOne\":{\"@id\":\"ESAllPrim(32767)\",\"PropertyInt16\":32767,"
        + "\"PropertyDate\":\"2012-12-03\"}}",
        resultString);
  }
  ...
  public void expandAll() throws Exception {
    ...
    Assert.assertEquals("{"
        ...
        + "\"@metadataEtag\":\"W/\\\"metadataETag\\\"\","
        + "\"@id\":\"ESAllPrim(32767)\","
        + "\"PropertyInt16\":32767,\"PropertySByte\":127,"
  ...
  public void expandNoData() throws Exception {
    ...
    Assert.assertEquals("{"
        ...
        + "\"@metadataEtag\":\"W/\\\"metadataETag\\\"\","
        + "\"@id\":\"ESAllPrim(-32768)\","
        + "\"PropertyInt16\":-32768,\"PropertyTimeOfDay\":\"23:49:14\","
  ...
  public void complexPropertyWithMetadataFull() throws Exception {
    ...
    Assert.assertEquals("{\"@context\":\"../$metadata#ESMixPrimCollComp(32767)/PropertyComp\"," +
                ...
                "\"NavPropertyETTwoKeyNavOne@navigationLink\":\"ESTwoKeyNav(PropertyInt16=1,PropertyString='1')\"}"
                 ,resultString);
  }
